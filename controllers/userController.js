import { genterateToken } from "../lib/utils.js";
...
export const Signup = async (req, res)=>{
   ...
   const token = genterateToken(newUser._id)
...
export const login = async (req, res) => {
    try {
      ...
      const token = genterateToken(userData._id)
...
// Controller to check if yer is authenticated
